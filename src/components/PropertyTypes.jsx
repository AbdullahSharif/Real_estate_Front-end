...
function PropertyTypes() {
  ...
  return (
    <div className="flex flex-col space-y-16 text-3xl font-semibold">
      ...
      <Link className="bg-slate-800 p-6 rounded-tr-[4rem] rounded-bl-[4rem] flex flex-col space-y-4 items-center hover:scale-105 transition ease-in-out shadow-2xl">
      ...
      <Link className="bg-slate-800 p-6 rounded-bl-[4rem] rounded-tr-[4rem] flex flex-col space-y-4 items-center hover:scale-105 transition ease-in-out shadow-2xl">
        <div className="relative">
